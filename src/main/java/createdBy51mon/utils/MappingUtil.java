...
public class MappingUtil {
    public static AddressDTO mapAddress(HttpServletRequest req) {
        return AddressDTO.builder()
                .id(ServletParamUtil.getIntegerParam(req, AddressServletConstants.ADDRESS_ID_PARAM))
    ...
    public static ApartmentDTO mapApartment(HttpServletRequest req) {
        return ApartmentDTO.builder()
                .id(ServletParamUtil.getIntegerParam(req, ApartmentServletConstants.APARTMENT_ID_PARAM))
                .apartmentNumber(ServletParamUtil.getIntegerParam(req, ApartmentServletConstants.APARTMENT_NUMBER_PARAM))
    ...
    public static PersonDTO mapPerson(HttpServletRequest req) {
        return PersonDTO.builder()
                .id(ServletParamUtil.getIntegerParam(req, PersonServletConstants.PERSON_ID_PARAM))
