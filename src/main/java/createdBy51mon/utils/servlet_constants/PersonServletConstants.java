...
public class PersonServletConstants {
     ...
     * Servlet constants
     */
    public static final String PERSONS_LIST_SERVLET = "persons_list";
    public static final String PERSONS_SAVE_SERVLET = "person_save";
    public static final String PERSONS_UPDATE_SERVLET = "person_update";
    public static final String PERSONS_DELETE_SERVLET = "person_delete";
    /**
     * JSP constants
     */
    public static final String PERSONS_LIST_JSP = "/persons_list.jsp";
    public static final String PERSONS_SAVE_JSP = "/person_save.jsp";
    ...
    public static final String PERSONS_LIST_ATTRIBUTE = "persons";
}
